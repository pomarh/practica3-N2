            ...
            <main className=" ">
                ...
                <section className="bg-gray-100 p-4">
                    ...
                    <form className="bg-white p-4 border border-gray-300 rounded-lg" action="">
                        ...
                        <input className=" w-12/12 h-12 bg-with rounded-lg border border-gray-300 px-2 mb-5" type="text" placeholder="Full name" />
                    ...
                    <div className="bg-white p-4 border border-gray-300 rounded-lg mt-8">
                        <div className="flex  items-center gap-2 mb-5">
                            <div className="w-10 h-10 bg-gray-200 rounded-lg flex justify-center items-center">
                        ...
                        <div className=" flex justify-between items-center">
                            ...
                            <div className="w-82 h-14 p-2 flex items-center gap-2 bg-gray-200 rounded-lg">
                ...
                <footer className="flex justify-around items-center m-5">
